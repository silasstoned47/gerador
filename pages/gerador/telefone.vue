  ...
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="tool-card mb-8">
        ...
        <div>
          ...
          <div class="space-y-2">
            <label class="flex items-center">
              ...
              >
              <span class="ml-2 text-gray-700">Com formatação (11) 3333-4444</span>
            </label>
            <label class="flex items-center">
              <input 
                v-model="options.formatted" 
                ...
                class="text-blue-600 focus:ring-blue-500"
              >
              <span class="ml-2 text-gray-700">Sem formatação 1133334444</span>
            </label>
          </div>
        </div>
      ...
      <div class="flex flex-col sm:flex-row gap-4">
        <button @click="generateFixo" class="btn-primary">
    ...
    <!-- Information Section -->
    <div class="tool-card mb-8">
      <h2 class="text-xl font-semibold text-gray-900 mb-4">Sobre os Números de Telefone Fixo Brasileiros</h2>
      <div class="prose prose-gray max-w-none">
        <p class="text-gray-600 mb-4">
          No Brasil, os números de telefone fixo seguem o formato: (DDD) XXXX-XXXX, onde:
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <ul class="space-y-1 text-gray-600">
              ...
              <li>• <strong>Primeiro dígito:</strong> 2, 3, 4 ou 5 (nunca 9)</li>
              <li>• <strong>XXX-XXXX:</strong> 7 dígitos restantes</li>
            </ul>
          </div>
    ...
    <div class="tool-card">
      ...
      <div class="space-y-4">
        ...
        <div class="border-b border-gray-200 pb-4">
          <h3 class="font-medium text-gray-900 mb-2">Por que os números fixos não começam com 9?</h3>
          <p class="text-gray-600">
            No Brasil, telefones fixos começam com dígitos 2, 3, 4 ou 5 após o DDD. 
            O número 9 é exclusivo para celulares.
          </p>
        </div>
...
// SEO Meta tags
useSeoMeta({
  title: 'Gerador de Telefone Fixo Online | Gerador II',
  description: 'Gere números de telefone fixo brasileiros válidos para testes com DDDs corretos por região. Dados fictícios seguindo padrão nacional.',
  keywords: 'gerador telefone fixo, numero fixo, gerar telefone, telefone fictício, teste telefone, telefone online, ddd brasil',
  ogTitle: 'Gerador de Telefone Fixo - Gerador II',
  ogDescription: 'Gere números de telefone fixo válidos para seus testes por região.'
})
